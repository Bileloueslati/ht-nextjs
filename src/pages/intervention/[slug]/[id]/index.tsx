...
export default function Category({
  category: {
    data: {
      attributes: { name, description, content, image, services },
    },
  },
}: Props) {
  return (
            ...
            <Grid item lg={8} xs={12}>
              ...
              >
                <Button
                  ...
                  size="large"
                  component="a"
                  href="https://perso.healthtravel.fr/"
                  target="_blank"
                >
                  Demander un devis
                </Button>
              ...
              <Grid container spacing={5}>
                {services?.data.map(({ id, attributes: { name, ...rest } }) => (
                  <Grid key={id} item lg={6} xs={12}>
                    <GridCard link="/" title={name} {...rest} />
                  </Grid>
                ))}
              </Grid>
            </Grid>
